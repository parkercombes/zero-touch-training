...
SCENARIO = {
    ...
    # Common pre-flight mistakes for the rotating challenge cards (Level 3)
    "premises": [
        {
            "headline":   "First flight of the morning. Cold battery, half-light, hurry.",
            "context":    "You're the first to arrive on-site. Pre-flight feels routine after a thousand of them. The temptation to rush is highest right now.",
        },
        {
            "headline":   "New site. You've never flown here before.",
            "context":    "Obstacles you haven't seen. Airspace you haven't checked. The default RTH altitude is the wrong altitude for this site.",
        },
        {
            "headline":   "Firmware updated last night.",
            "context":    "The aircraft and app updated in the truck overnight. Compatibility is not guaranteed. The version banner is more important today than usual.",
        },
        {
            "headline":   "Rental aircraft, returned by a previous operator.",
            "context":    "You don't know what's been done to this airframe. Propellers may have been swapped incorrectly. Battery may not be the original. Inspect every step.",
        },
    ],
}
